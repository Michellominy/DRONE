...
-- Command     : write_vhdl -force -mode synth_stub -rename_top drone_base_axi_smc_0 -prefix
--               drone_base_axi_smc_0_ drone_base_axi_smc_0_stub.vhdl
...
entity drone_base_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of drone_base_axi_smc_0 : entity is "drone_base_axi_smc_0,bd_0831,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of drone_base_axi_smc_0 : entity is "drone_base_axi_smc_0,bd_0831,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VERILOG,x_ipSimLanguage=VHDL}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of drone_base_axi_smc_0 : entity is "yes";
end drone_base_axi_smc_0;

architecture stub of drone_base_axi_smc_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN drone_base_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:S00_AXI:S01_AXI:S02_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_0831,Vivado 2025.2";
begin
end;
