...
-- Date        : Fri May  8 15:56:22 2026
-- Host        : Michel-PC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub
--               c:/Users/lomin/Documents/git/DRONE/overlay/drone_overlay.gen/sources_1/bd/drone_base/ip/drone_base_hardware_pid_engine_0_0/drone_base_hardware_pid_engine_0_0_stub.vhdl
-- Design      : drone_base_hardware_pid_engine_0_0
...
entity drone_base_hardware_pid_engine_0_0 is
  Port ( 
  ...
  attribute CHECK_LICENSE_TYPE of drone_base_hardware_pid_engine_0_0 : entity is "drone_base_hardware_pid_engine_0_0,hardware_pid_engine,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of drone_base_hardware_pid_engine_0_0 : entity is "drone_base_hardware_pid_engine_0_0,hardware_pid_engine,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=hardware_pid_engine,x_ipVersion=1.0,x_ipCoreRevision=2114598602,x_ipLanguage=VERILOG,x_ipSimLanguage=VHDL,C_S_AXI_CTRL_BUS_ADDR_WIDTH=8,C_S_AXI_CTRL_BUS_DATA_WIDTH=32}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of drone_base_hardware_pid_engine_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of drone_base_hardware_pid_engine_0_0 : entity is "HLS";
  attribute hls_module : string;
  attribute hls_module of drone_base_hardware_pid_engine_0_0 : entity is "yes";
end drone_base_hardware_pid_engine_0_0;

architecture stub of drone_base_hardware_pid_engine_0_0 is
  attribute syn_black_box : boolean;
  attribute black_box_pad_pin : string;
  attribute syn_black_box of stub : architecture is true;
  attribute black_box_pad_pin of stub : architecture is "s_axi_CTRL_BUS_ARADDR[7:0],s_axi_CTRL_BUS_ARREADY,s_axi_CTRL_BUS_ARVALID,s_axi_CTRL_BUS_AWADDR[7:0],s_axi_CTRL_BUS_AWREADY,s_axi_CTRL_BUS_AWVALID,s_axi_CTRL_BUS_BREADY,s_axi_CTRL_BUS_BRESP[1:0],s_axi_CTRL_BUS_BVALID,s_axi_CTRL_BUS_RDATA[31:0],s_axi_CTRL_BUS_RREADY,s_axi_CTRL_BUS_RRESP[1:0],s_axi_CTRL_BUS_RVALID,s_axi_CTRL_BUS_WDATA[31:0],s_axi_CTRL_BUS_WREADY,s_axi_CTRL_BUS_WSTRB[3:0],s_axi_CTRL_BUS_WVALID,ap_clk,ap_rst_n,interrupt";
  ...
  attribute X_INTERFACE_PARAMETER of ap_clk : signal is "XIL_INTERFACENAME ap_clk, ASSOCIATED_BUSIF s_axi_CTRL_BUS, ASSOCIATED_RESET ap_rst_n, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN drone_base_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute X_CORE_INFO of stub : architecture is "hardware_pid_engine,Vivado 2025.2";
begin
end;
