...
// Date        : Sat Jun 13 14:26:43 2026
// Host        : Michel-PC running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub -rename_top drone_block_design_axi_smc_1 -prefix
//               drone_block_design_axi_smc_1_ drone_block_design_axi_smc_1_stub.v
// Design      : drone_block_design_axi_smc_1
...
(* CHECK_LICENSE_TYPE = "drone_block_design_axi_smc_1,bd_6acc,{}" *) (* CORE_GENERATION_INFO = "drone_block_design_axi_smc_1,bd_6acc,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_6acc,Vivado 2025.2" *) 
module drone_block_design_axi_smc_1(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
