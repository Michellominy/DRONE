...
#
# Script generated by Vivado on Sat Jun 27 20:59:39 -0400 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : drone_block_design.sh
...
#
# Usage        : drone_block_design.sh
#                drone_block_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                drone_block_design.sh [-rerun]
#                drone_block_design.sh [-reset_run]
#                drone_block_design.sh [-clean]
#                drone_block_design.sh [-reset_log]
#                drone_block_design.sh [-help]
#
...
# script info
echo -e "drone_block_design.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./drone_block_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_37 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L gigantic_mux -L xlconstant_v1_1_10 -L generic_baseblocks_v2_1_2 -L fifo_generator_v13_2_14 -L axi_data_fifo_v2_1_36 -L axi_protocol_converter_v2_1_37 -L axi_clock_converter_v2_1_35 -L blk_mem_gen_v8_4_12 -L axi_dwidth_converter_v2_1_37 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot drone_block_design xil_defaultlib.drone_block_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim drone_block_design -key {Behavioral:sim_1:Functional:drone_block_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6acc.protoinst" -protoinst "protoinst_files/bd_ea65.protoinst" -protoinst "protoinst_files/drone_block_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb drone_block_design.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./drone_block_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: drone_block_design.sh [-help]\n\
Usage: drone_block_design.sh [-step]\n\
Usage: drone_block_design.sh [-lib_map_path]\n\
Usage: drone_block_design.sh [-rerun]\n\
Usage: drone_block_design.sh [-reset_run]\n\
Usage: drone_block_design.sh [-clean]\n\
Usage: drone_block_design.sh [-reset_log]\n\
Usage: drone_block_design.sh [-keep_index]\n\
Usage: drone_block_design.sh [-noclean_files]\n\n\
