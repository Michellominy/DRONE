...
#                script (type 'drone_block_design.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/lomin/Documents/git/DRONE/rtl_controller/drone_overlay/drone_overlay.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
