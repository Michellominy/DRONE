...
HD_PWD='C:/Users/lomin/Documents/git/DRONE/rtl_controller/drone_overlay/drone_overlay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log drone_block_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source drone_block_design_wrapper.tcl -notrace
