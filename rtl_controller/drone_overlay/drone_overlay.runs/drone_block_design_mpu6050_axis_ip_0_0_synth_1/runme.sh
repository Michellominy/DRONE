...
HD_PWD='C:/Users/lomin/Documents/git/DRONE/rtl_controller/drone_overlay/drone_overlay.runs/drone_block_design_mpu6050_axis_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log drone_block_design_mpu6050_axis_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source drone_block_design_mpu6050_axis_ip_0_0.tcl
